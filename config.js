...
module.exports = {
  ...
  botname:   process.env.BOT_NAME === undefined ? 'MTAJU BOT' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'Lazack' : process.env.OWNER_NAME,
  author:  process.env.PACK_INFO === undefined ? 'bot' : process.env.PACK_INFO.split(";")[0],
  auto_read_status :  process.env.AUTO_READ_STATUS === undefined ? false : process.env.AUTO_READ_STATUS,
  packname:  process.env.PACK_INFO === undefined ? 'mtaju-bot' : process.env.PACK_INFO.split(";")[1],
